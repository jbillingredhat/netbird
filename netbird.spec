...
License:        AGPL-3.0-only AND Apache-2.0 AND BSD-2-Clause AND BSD-3-Clause AND CC0-1.0 AND GPL-3.0-only AND ISC AND MIT AND MPL-2.0 AND Unlicense AND Zlib
URL:            %{gourl}
Source0:        %{gosource}
# Generated by go-vendor-tools
...
# UI NodeJS
Source10:        netbird-ui-assets-%{version}.tgz
...
# For building UI
BuildRequires: webkitgtk6.0-devel, gtk4-devel, glib2-devel
...
# extract UI elements
tar -C ui/frontend/ -xvf %{SOURCE10}

%gobuild -o %{gobuilddir}/bin/client %{goipath}/client

pushd ui
# Build frontend
%gobuild -o %{gobuilddir}/bin/ui %{goipath}/client/ui
popd
...
install -m 0755 -vp client/ui/build/linux/netbird.desktop %{buildroot}%{_datarootdir}/applications/netbird.desktop
install -m 0755 -vp client/ui/build/appicon.png %{buildroot}%{_datarootdir}/icons/netbird.png
