srpm:
	...
	cp netbird*.tar.gz netbird*.tar.bz2 go-vendor-tools.toml *.patch netbird.service netbirdui.service client_config.json netbird.logrotate /tmp/_topdir/SOURCES/
